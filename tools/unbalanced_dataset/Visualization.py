...
def vizualization():
    ...
    sx, sy = smote.fit_transform(smote.fit_transform(smote.fit_transform(smote.fit_transform(x, y))))

    bsmote1 = bSMOTE1(random_state=1)
    # bsx1, bsy1 = bsmote1.fit_transform(x, y)
    bsx1, bsy1 = bsmote1.fit_transform(bsmote1.fit_transform(bsmote1.fit_transform(x, y)))

    bsmote2 = bSMOTE2(random_state=1)
    # bsx2, bsy2 = bsmote2.fit_transform(x, y)
    bsx2, bsy2 = bsmote2.fit_transform(bsmote2.fit_transform(bsmote2.fit_transform(x, y)))
